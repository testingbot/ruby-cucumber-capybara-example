[![Build Status](https://travis-ci.org/testingbot/ruby-cucumber-capybara-example.svg?branch=master)](https://travis-ci.org/testingbot/ruby-cucumber-capybara-example)
